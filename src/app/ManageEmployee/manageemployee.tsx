...
export default function CreateUD() {
  ...
  const handleData = (data: any) => {
    ...
    setCurrentMode("edit");
    let { empno, fname, mname, lname, dateofbirth, contactno, address, position, gender, maritalstatus, acctid, role_id, isdayshift, status, schedule } = data;
    let currentData = {
      empno,
      fname,
      mname,
    ...
    <div className="crud-maindiv">
      <div className="modal fade" id="resetPasswordModal" aria-labelledby="resetPasswordModalLabel" aria-hidden="true">
        <div className="modal-dialog">
          <div className="modal-content" style={{width:'500px !important'}}>
