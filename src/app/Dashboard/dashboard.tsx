              ...
              <div id="panelsStayOpen-collapseOne" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne" style={{ marginTop: "-20px" }}>
                <div className="undermanage-hover accordion-body">
                  {user_privilege.includes("manage_users") && (
                    ...
                    <a onClick={() => router.push("/ManageAccount")} style={{ color: '#ffffff', textDecoration: 'none', display: 'block', marginTop: '10px' }}>
                  ...
                  <a onClick={() => router.push("/ManageEmployee")} style={{ color: '#ffffff', textDecoration: 'none', display: 'block',  marginTop: '20px' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-circle" viewBox="0 0 16 16" style={{marginRight:'21px'}}>
                      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                    </svg> Employee
                  </a>
            ...
            <div className="manage-menu accordion-item">
              ...
              >
                <div
                  ...
                  style={{ color: '#ffffff' }} // Default text color is white
                ...
                >
                  ...
                  <svg
                    ...
                    height="20"
                    fill="currentColor"
                    className={`bi bi-chevron-up ${accordionIcon ? "rotate-acc-icon" : ""}`}
                    viewBox="0 0 16 16"
                ...
                <div
                  id="panelsStayOpen-collapseOnee"
                  className="accordion-collapse collapse show"
                  aria-labelledby="panelsStayOpen-headingOne"
                  style={{ marginTop: "-10px" }}
                >
                  <div className="accordion-body">
                    <li className="updatepass-hover" style={{ whiteSpace: 'nowrap' }}>
                      <Updatepassword />
                    </li>
                  </div>
                </div>
