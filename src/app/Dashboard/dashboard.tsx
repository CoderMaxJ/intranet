    ...
    >
      ...
      <div>
        <div style={{ marginLeft: '10px' }}>
          ...
          <button onClick={() => router.push("/")} style={{ border: "none", background: "transparent" }}>
          Dashboard
          </button>
        ...
        <div className="admin">
          ...
          <div className="accordion-item d-flex w-100 " data-bs-toggle="collapse" data-bs-target="#collapseThree" style={{ padding: "10px" }}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-people" viewBox="0 0 16 16" style={{marginRight:'18px'}}>
      ...
      {user_privilege.includes("manage_users") && (
        <div>
          <div className="admin" style={{ alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
            <div className="accordion-item d-flex w-100" data-bs-toggle="collapse" data-bs-target="#collapseThree1" style={{ padding: "10px", marginRight:'83px' }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="23" height="21" fill="currentColor" className="bi bi-person-gear" viewBox="0 0 16 16" style={{ marginRight: "18px" }}>
              ...
              <h2 className="accordion-header" id="headingThree1">
                <button className="accordion-button collapsed" type="button" aria-expanded="true" aria-controls="collapseThree1">
                  Manage
                </button>
              </h2>
            </div>
          ...
          <div id="collapseThree1" className="accordion-collapse collapse" aria-labelledby="headingThree1" data-bs-parent="#accordionExample">
            <div className="drop accordion-body">
              <ul className="list-unstyled">
                <li onClick={() => router.push("/ManageDepartment")} className="manage-hover">
                  <a style={{ textDecoration: 'none', justifyContent: 'center' }}>
                    Accounts
                  </a>
                </li>
                <li onClick={() => router.push("/Crud")} style={{ cursor: "pointer" }} className="manage-hover">
                  <a style={{ textDecoration: 'none', justifyContent: 'center' }}>
                    Manage Employee
                  </a>
                </li>
