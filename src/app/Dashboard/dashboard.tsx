            ...
            >
                ...
                <div style={{ overflow: 'hidden' }}>
                    <div className="generate" onClick={() => navigateTo("/WorkforceMonitoring", "1")}
                        style={{ backgroundColor: localStorage.getItem("active_tab") === "1" ? "green" : "" }}>
                    ...
                    <div className="generate" onClick={() => navigateTo("/Reports", "2")}
                        style={{ backgroundColor: localStorage.getItem("active_tab") === "2" ? "green" : "" }}>

                        <a className="nav-font " style={{ color: '#ffffff' }}>
                            <svg
                    ...
                    <div>
                        <div className="generate" onClick={() => navigateTo("/Schedule", "3")}
                            style={{ backgroundColor: localStorage.getItem("active_tab") === "3" ? "green" : "" }}>

                            <a className="nav-font " style={{ color: '#ffffff' }}>

                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar2-check" viewBox="0 0 16 16" style={{ marginRight: '24px' }}>
                                    <path d="M10.854 8.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L7.5 10.793l2.646-2.647a.5.5 0 0 1 .708 0" />
                                    <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M2 2a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1z" />
                                    <path d="M2.5 4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5z" />
                                </svg>
                                {showReports === true && (
                                    <label htmlFor="label">Schedule</label>
                                )}
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="manage-div">
                            ...
                            >
                                <div className="manage-nav">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" fill="currentColor" className="bi bi-person-gear text-secondary" viewBox="0 0 16 16" style={{ marginLeft: '-2px' }}>
                                ...
                                <div className="undermanage-hover accordion-body">
                                    <div className="manage-anchor">
                                        {user_privilege.includes("manage_users") && (
                                            <a className="nav-font" onClick={() => navigateTo("/ManageAccount", "4")}
                                                style={{ backgroundColor: localStorage.getItem("active_tab") === "4" ? "green" : "" }}>
                                    ...
                                    <div className="undermanage-hover">
                                        <div className="employee-anchor">
                                            <a className="nav-font" onClick={() => navigateTo("/ManageEmployee", "5")}
                                                style={{ backgroundColor: localStorage.getItem("active_tab") === "5" ? "green" : "" }}>

                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor text-secondary" className="employee-icon bi bi-people" viewBox="0 0 16 16">
                            ...
                            >
                                ...
                                <div className="updatepassword-hover">
                                    ...
                                    >
                                        ...
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill=" text-secondary" className="bi bi-shield-lock" viewBox="0 0 16 16" style={{ marginRight: '24px' }}>
                        ...
                        {open === false && showProfile === true && (
                            <div className="profile-div position-relative">
                                <div className="dot-div position-absolute">
                                    <svg onClick={toggleinput} xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor text-secondary" className="bi bi-camera-fill text-light" viewBox="0 0 16 16">
